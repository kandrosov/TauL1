...
from .Performance.eval_tools import get_shortest_interval
...
def eval_resolution(cfg, dataset_file, scores_file, output_path):
...
if __name__ == "__main__":
  ...
  eval_resolution(cfg['resolution'], args.dataset, args.scores, args.output)
